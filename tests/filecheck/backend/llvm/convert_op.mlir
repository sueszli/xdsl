...
builtin.module {
  ...
  llvm.func @inline_asm_no_flags(%arg0: i32) {
    llvm.inline_asm "add $0, 1", "r" %arg0 : (i32) -> ()
    llvm.return
  }

  // CHECK: define void @"inline_asm_no_flags"(i32 %".1")
  // CHECK-NEXT: {
  // CHECK-NEXT: {{.[0-9]+}}:
  ...
  llvm.func @inline_asm_att(%arg0: i32) {
    llvm.inline_asm asm_dialect = att "add $0, 1", "r" %arg0 : (i32) -> ()
    llvm.return
  }

  // CHECK: define void @"inline_asm_att"(i32 %".1")
  // CHECK-NEXT: {
  // CHECK-NEXT: {{.[0-9]+}}:
  // CHECK-NEXT:   call void asm  "add $0, 1", "r"(i32 %".1")
  // CHECK-NEXT:   ret void
  ...
  llvm.func @inline_asm_intel(%arg0: i32) {
    llvm.inline_asm asm_dialect = intel "add $0, 1", "r" %arg0 : (i32) -> ()
    llvm.return
  }

  // CHECK: define void @"inline_asm_intel"(i32 %".1")
  // CHECK-NEXT: {
  // CHECK-NEXT: {{.[0-9]+}}:
  // CHECK-NEXT:   call void asm  "add $0, 1", "r"(i32 %".1")
  // CHECK-NEXT:   ret void
