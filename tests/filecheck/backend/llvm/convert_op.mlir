...
builtin.module {
  llvm.func external @declaration() {
  }

  // CHECK: declare void @"declaration"()

  llvm.func external @named_entry() {
  ^entry:
    llvm.return
  }
  ...
  llvm.func external @custom_name() {
  ^my_block:
    llvm.return
  }
  ...
  llvm.func external @return_void() {
    llvm.return
  }
  ...
  llvm.func external @return_arg(%arg0 : i32) -> i32 {
  ...
  llvm.func external @return_second_arg(%arg0 : i32, %arg1 : i32) -> i32 {
  ...
  llvm.func external @binops(%arg0 : i32, %arg1 : i32, %arg2 : f32, %arg3 : f32) {
